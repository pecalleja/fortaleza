...
export const links = [
  ...
  // Room 3
  {
    ...
    fromRoomId: 3,
    destinationId: 5,
    riddleEs: '¿Cuántos peldaños tiene la escalera?',
    riddleEn: 'How many steps does the staircase have?',
    answer: 'treinta y nueve',
    passageMsgEs: 'Usted sube por la escalera. No se explica cómo, siendo tan larga, solo tiene treinta y nueve escalones.',
  ...
  // Room 5
  {
    ...
    passageMsgEs: 'Usted se sorprende: La escalera tiene ahora muchos escalones más.',
  ...
  },
  {
    ...
    destinationId: 14,
    talisman: 'candelabro',
    passageMsgEs: 'Usted cae durante varios minutos y, gracias al candelabro, cuando toca el suelo no se hace daño. Oye una voz que dice: Sea gentil con la doncella, regálele una flor.',
  ...
  // Room 12
  {
    ...
    destinationId: 13,
    password: '',
    passageMsgEs: 'Usted entra al jardín.',
  ...
  // Room 13
  {
    ...
    destinationId: 12,
    password: '',
    passageMsgEs: 'Usted sale del jardín.',
  ...
  },
  {
    ...
    nameEs: 'Tráquea',
    nameEn: 'Trachea',
    descEs: 'Es la tráquea de la Bestia.',
    descEn: 'It is the trachea of the Beast.',
    fromRoomId: 18,
    destinationId: 19,
    talisman: 'talisman-aire',
    passageMsgEs: 'Usted atraviesa por la tráquea de la Bestia.',
  ...
  },
  {
    ...
    nameEs: 'Esófago',
    nameEn: 'Esophagus',
    descEs: 'Es el esófago de la Bestia.',
    descEn: 'It is the esophagus of the Beast.',
    fromRoomId: 18,
    destinationId: 20,
    talisman: 'pastel-cerezas',
    passageMsgEs: 'Usted atraviesa por el esófago de la Bestia.',
  ...
  // Room 19
  {
    ...
    destinationId: 18,
    password: '',
    passageMsgEs: 'Usted regresa a la tráquea.',
  ...
  // Room 20
  {
    ...
    destinationId: 18,
    password: '',
    passageMsgEs: 'Usted regresa al esófago.',
  ...
  },
  {
    ...
    fromRoomId: 24,
    destinationId: 1,
    passageMsgEs: 'Usted cae vertiginosamente por el pozo y, antes de que pueda darse cuenta, está en el exterior de la fortaleza.',
  ...
  },
  {
    ...
    nameEs: 'Túnel',
    nameEn: 'Tunnel',
    descEs: 'Es un túnel oscuro.',
    descEn: 'It is a dark tunnel.',
    fromRoomId: 24,
    destinationId: 24,
    talisman: 'nada',
    passageMsgEs: 'Usted entra al túnel de la muerte...',
  ...
  },
  {
    ...
    fromRoomId: 25,
    destinationId: 17,
    riddleEs: '¿Cuál es el nombre del duende?',
  ...
  // Room 31
  {
    ...
    nameEs: 'Puerta 1',
    nameEn: 'Door 1',
    descEs: 'Es una de las tres puertas simétricas.',
  ...
  },
  {
    ...
    fromRoomId: 50,
    destinationId: 30,
    riddleEs: '¿Cuántas antorchas iluminan al Minotauro?',
